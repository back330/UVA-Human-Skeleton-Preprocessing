...
The filename of all uva (A total of 23031 samples) is stored in skes_available_name.txt as shown below, and all sample action types are extracted (the number behind the <font color="#dd0000"> blue box A </font><br /> in the following figure) and stored in the label.txt file as shown below  
